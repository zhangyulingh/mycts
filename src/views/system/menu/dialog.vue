        ...
        <el-row :gutter="35">
          ...
          <template v-if="state.ruleForm.menuType === 'menu'">
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
              <el-form-item label="权限标识">
                <el-select v-model="state.ruleForm.meta.roles" multiple placeholder="取角色管理" clearable class="w-full">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
            <el-form-item label="菜单排序">
              <el-input-number v-model="state.ruleForm.menuSort" controls-position="right" placeholder="请输入排序" class="w-full" />
            </el-form-item>
          </el-col>
          <template v-if="state.ruleForm.menuType === 'menu'">
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
