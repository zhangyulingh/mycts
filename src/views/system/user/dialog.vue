  ...
  <div class="system-user-dialog-container">
    <el-dialog :title="state.dialog.title" v-model="state.dialog.isShowDialog" width="769px">
      <el-form ref="userDialogFormRef" :model="state.ruleForm" size="default" label-width="90px">
        <el-row :gutter="35">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
            <el-form-item label="关联角色">
              <el-select v-model="state.ruleForm.roleSign" placeholder="请选择" clearable class="w-full">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
            <el-form-item label="性别">
              <el-select v-model="state.ruleForm.sex" placeholder="请选择" clearable class="w-full">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
            <el-form-item label="账户过期">
              <el-date-picker v-model="state.ruleForm.overdueTime" type="date" placeholder="请选择" class="w-full"> </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20px">
