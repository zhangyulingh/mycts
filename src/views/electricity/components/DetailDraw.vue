...
<template>
  <el-drawer size="80%" v-model="visible" :show-close="true">
    <template #header="{titleId, titleClass}">
      <h4 :id="titleId" :class="titleClass">电价配置详情</h4>
    </template>
    <div class="p-4">
      <div>
        <el-descriptions class="margin-top" :column="2" border>
          ...
          <el-descriptions-item>
            ...
            <el-tag size="small" :type="detailData.isDisable === true ? 'danger' : 'success'">
          ...
          <el-descriptions-item>
            ...
            <el-tag size="small" :type="detailData.isApply === true ? 'success' : 'danger'">
