  ...
  <div class="layout-breadcrumb-seting">
    <el-drawer title="布局配置" v-model="getThemeConfig.isDrawer" direction="rtl" destroy-on-close size="260px" @close="onDrawerClose">
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt-15px" :style="{opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1}">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt-15px" :style="{opacity: getThemeConfig.layout !== 'classic' ? 0.5 : 1}">
        ...
        <div
          class="layout-breadcrumb-seting-bar-flex mt-15px"
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt-15px" :style="{opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1}">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt-15px mb27" :style="{opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1}">
